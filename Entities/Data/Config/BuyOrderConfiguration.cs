...
public class BuyOrderConfiguration : IEntityTypeConfiguration<BuyOrder>
{
    public void Configure(EntityTypeBuilder<BuyOrder> builder)
    {
        ...
        builder.Property(bo => bo.StockSymbol).HasMaxLength(20).IsRequired();

        builder.Property(bo => bo.StockName).HasMaxLength(100).IsRequired();

        builder.Property(bo => bo.DateAndTimeOfOrder).HasColumnType("datetime2").IsRequired();

        builder.Property(bo => bo.Quantity).IsRequired();

        builder.Property(bo => bo.Price).HasPrecision(15, 2).IsRequired();
